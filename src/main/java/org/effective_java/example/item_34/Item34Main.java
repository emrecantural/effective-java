package org.effective_java.example.item_34;

public class Item34Main {
  /**
   * 34. Java Enums & Strategy Design Pattern (Enumlara Birde Böyle Bakın!)
   */

  // Tür güvenliği yok.
  // Debug zorlaşacak

  public static final int APPLE_FUJI         = 0; //Eski  java dizaynları
  /**
   * Bağlantılı oldukları belli değil
   * kullanımı değişik appledan orangeye geçersen uyarı vermeyecek
   */
